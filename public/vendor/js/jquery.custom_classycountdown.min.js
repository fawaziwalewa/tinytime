...
(function (c) {
    c.fn.ClassyCountdown = function (k, r) {
        ...
        function counterStart(ca){
            ...
            // const originalEndtime = new Date(new Date(b.end) - (new Date().getTimezoneOffset() * 60 * 1000));
            // let stoper = endTime;
            console.log("diff: "+diff);
            console.log("endTime: "+new Date(endTime));
            console.log("Original endTime: "+new Date(new Date(b.end) - (new Date().getTimezoneOffset() * 60 * 1000)));
            // console.log(new Date(endTime.getTime() - startTime.getTime()));
            Timer = countdown(
                endTime,
                function(ts) {
                    // stoper++;
                    // if (stoper >= originalEndtime) {
                    //     console.log("Ended")
                    // }
                    // const timeNow = convertTime(ts.days, ts.hours, ts.minutes, ts.seconds)
                    // if (false) {
        ...
        //     let createdDate = new Date(ca);
        //     createdDate = createdDate.addDays(parseInt(days));
