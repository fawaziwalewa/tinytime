...
(function(c) {
    c.fn.ClassyCountdown = function(k, r) {
        ...
        $("#generateLinkForm").submit(function (e) { 
            ...
            // alert($('#generateLinkForm > input[name=_token]').val())
            // return;
            const obj = {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $('#emBedLink').removeClass('d-none');
                    $('#generatedLink').removeClass('d-none');
                    $('#generateLinkForm > .message').html("<p class='alert alert-success'><strong>Success!</strong> The Embed code and Generated Link are only available before the timer runs out. Once the timer runs out, they will expire.</p>");
                },
                error: function(xhr, err) {
                    var err = eval("(" + xhr.responseText + ")");
                    $('#generateLinkForm > .message').html("<p class='alert alert-danger'><strong>Opps!</strong> " + err.message + "</p>");
                }  
            });
        });
