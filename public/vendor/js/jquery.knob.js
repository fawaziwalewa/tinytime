            ...
            if (this.relative) {
                var e = this.relativeWidth
                        ? (this.$div.parent().width() *
                              parseInt(this.o.width, 10)) /
                          100
                        : this.$div.parent().width(),
                    t = this.relativeHeight
                        ? (this.$div.parent().height() *
                              parseInt(this.o.height, 10)) /
                          100
                        : this.$div.parent().height();
