...
<body>
    <section id="wrapper" class="video black min-h-screen flex flex-col justify-center items-center relative">
        ...
        <div class="container-fluid animated" id="home">
            <div class="absolute top-2 right-5 mode mt-2">
            ...
            <div class="middle-area">
                ...
                <div class="flex flex-col justify-center md:flex-row mt-2">
        ...
        <div class="footer mt-1">
            ...
            <div class="text-center terms">
                <a href="{{ route('privacy') }}" target="_blank" class="text-white mx-md-3 mx-sm-2">Privacy
                    Policy</a>
                <a href="{{ route('terms') }}" target="_blank" class="text-red-900 mx-md-3 mx-sm-2">Terms of
                    Services</a>
            </div>
        </div> <!-- Footer -->
        {{-- <div class="container-fluid otherpage animated" id="about">
                    ...
                    <div class="modal-body">
                        <form method="post" action="{{ route('customUrl') }}" id="generateLinkForm">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control placeholder:text-gray-600" id="name" name="name"
                                    placeholder="Enter a name for your time." required>
                            </div>
                            <div class="mb-3">
                                <label for="description" class="col-form-label">description:</label>
                                <input type="text" class="form-control placeholder:text-gray-600" id="description" name="description"
                                    placeholder="Enter short description for the time.">
                            </div>
                            <div class="mb-3">
